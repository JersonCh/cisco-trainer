class CiscoTrainerExercise24 {
    ...
    initializeAnswers() {
        ...
        this.easyAnswers = {
            'input-1': 'Acceso Autorizado Solamente',
            'input-2': 'Ingrese credenciales',
            'input-3': 'console',
            'input-4': 'cisco123',
            'input-5': 'login'
        };
        ...
        this.hardAnswers = {
            'input-1': 'banner motd #Acceso Autorizado Solamente#',
            'input-2': 'banner login #Ingrese credenciales#',
            'input-3': 'line console 0',
            'input-4': 'password cisco123',
            'input-5': 'login'
        };
