class CiscoTrainerExercise21 {
    constructor() {
        this.score = 0;
        this.totalQuestions = 23;
    ...
    initializeAnswers() {
        ...
        this.correctAnswersEasy = {
            ...
            'input-9': 'vty 0 4',
            'input-10': 'cisco',
            'input-11': 'password-encryption',
            'input-12': 'motd',
            'input-13': 'vlan 1',
            'input-14': '192.168.1.11 255.255.255.0',
            'input-15': 'no shutdown',
            'input-16': 'default-gateway',
            'input-17': 'domain-name',
            'input-18': 'key generate rsa',
            'input-19': '1024',
            'input-20': 'admin secret Adm1nP@55',
            'input-21': 'input ssh',
            'input-22': 'local',
            'input-23': 'running-config startup-config'
        };
        ...
        this.correctAnswersHard = {
            ...
            'input-3': 'hostname S1',
            'input-4': 'no ip domain-lookup',
            'input-5': 'enable secret class',
            'input-6': 'line console 0',
            'input-7': 'password cisco',
            'input-8': 'login',
            'input-9': 'line vty 0 4',
            'input-10': 'password cisco',
            'input-11': 'service password-encryption',
            'input-12': 'banner motd',
            'input-13': 'interface vlan 1',
            'input-14': 'ip address 192.168.1.11 255.255.255.0',
            'input-15': 'no shutdown',
            'input-16': 'ip default-gateway',
            'input-17': 'ip domain-name',
            'input-18': 'crypto key generate rsa',
            'input-19': '1024',
            'input-20': 'username admin secret Adm1nP@55',
            'input-21': 'transport input ssh',
            'input-22': 'login local',
            'input-23': 'copy running-config startup-config'
        };
    ...
    checkAllAnswers() {
        ...
        if (window.CiscoTrainerApp) {
            window.CiscoTrainerApp.updateProgress(21, completed, Math.round(percentage));
        }
    }
